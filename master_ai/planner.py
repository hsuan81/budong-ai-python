...
class MasterAI:
    ...
    def _extract_json_from_response(self, response_text: str) -> Dict[str, Any]:
        ...
        # Clean the response
        print(f"Raw response from model before cleaning: {response_text}")
    ...
    async def generate_plan(self, user_request: str) -> Plan:
        ...
        print("Before model dump:", type(result.output), result.output)

        # Validate and create Plan object
        return Plan.model_validate(result.output)
    ...
    def generate_plan_sync(self, user_request: str) -> Plan:
        ...
        # Validate and create Plan object
        return Plan.model_validate(result.output)  # Validate and create Plan object
